...
- 雀魂网页版（[国服](https://majsoul.union-game.com/0/)√ | [日服](https://game.mahjongsoul.com)√ | [国际服](https://mahjongsoul.game.yo-star.com)√）
...
安装完成。请重新载入游戏页面。在使用本助手前，建议先看一下本页面下方的[示例](#示例)。
...
- 多家立直/副露时会显示综合危险度
- `[n无筋]` 指该玩家的无筋危险牌的剩余种类数。剩余种类数越少，这些无筋牌就越危险。剩余种类数为零表示该玩家是愚型听牌或振听（注：把 1m4m 这种算作一对筋牌，一共有 3*6=18 对筋牌）
