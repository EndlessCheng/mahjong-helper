...
func TestDivideTiles34(t *testing.T) {
	...
	const otherDivideResult = "國士無雙 or 未和牌"
	...
	assert.Equal("[99s 111s 123s 456s 789s][九蓮寶燈][一氣貫通]", divideTiles("11112345678999s"))
	...
	assert.Equal("[11s 999s 123s 456s 789s][九蓮寶燈][一氣貫通]", divideTiles("11123456789999s"))
	assert.Equal("[44s 123m 456m 789m 123s][一氣貫通]", divideTiles("123456789m 12344s"))
	assert.Equal("[11m 123p 456p 789p][一氣貫通]", divideTiles("11m 123456789p"))
	assert.Equal("[11p 123p 456p 789p][一氣貫通]", divideTiles("11123456789p"))
	assert.Equal("[11z 123m 123m 123p 123p][二盃口]", divideTiles("112233m 112233p 11z"))
